...
{
    public class InviteViewModel : ABaseViewModel
    {
        ...
        public InviteViewModel(IUserDialogs userDialogs,
        ...
        public override Task InitializeAsync(object navigationData)
        {
            ...
            {
                InviteTitle = $"Connect to {invitation.Label}?";
                InviterUrl = invitation.ImageUrl;
                InviteContents = $"{invitation.Label} would like to establish a pairwise DID connection with you. This will allow secure communication between you and {invitation.Label}.";
                _invite = invitation;
            }
